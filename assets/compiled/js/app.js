(function(ft) {
              ...
              "./node_modules/core-js/internals/define-iterator.js": function(s, f, r) {
                  ...
                  s.exports = function($, H, ue, yt, Te, rn, Nt) {
                      ...
                      var Oe = function(pe) {
                          ...
                          Ee, Se, De;
                      if (Lt && (Ee = u(Lt.call(new $)), O !== Object.prototype && Ee.next && (!A && u(Ee) !== O && (p ? p(Ee, O) : typeof Ee[w] != "function" && g(Ee, w, D)), h(Ee, mt, !0, !0), A && (_[mt] = D))), Te == L && _e && _e.name !== L && (Qe = !0, ge = function() {
                              return _e.call(this)
                          ...
                          if (Se = {
                              ...
                              for (De in Se)(T || Qe || !(De in le)) && m(le, De, Se[De]);
                          else l({
                              target: H,
                              proto: !0,
                              forced: T || Qe
  ...
  (function(U, k) {
      (function(s, f) {
          ...
          function Nr(n, e, t, i) {
              const o = e[t] || {};
              for (const [c, d] of Object.entries(o)) c.includes(i) && Ze(n, e, t, d.callable, d.delegationSelector)
          }

          function Yn(n) {
              return n = n.replace(rn, ""), Qe[n] || n
          }
          const x = {
              on(n, e, t, i) {
                  pe(n, e, t, i, !1)
              ...
              off(n, e, t, i) {
                  ...
                  if (j)
                      for (const I of Object.keys(b)) Nr(n, b, I, e.slice(1));
          ...
          class vt extends he {
              ...
              close() {
                  if (x.trigger(this._element, Ir).defaultPrevented) return;
                  this._element.classList.remove(Rr);
                  const t = this._element.classList.contains(Pr);
                  this._queueCallback(() => this._destroyElement(), this._element, t)
              }
              _destroyElement() {
                  this._element.remove(), x.trigger(this._element, $r), this.dispose()
              }
          ...
          class It extends gt {
              ...
              _initEvents() {
                  this._supportPointerEvents ? (x.on(this._element, Gr, e => this._start(e)), x.on(this._element, Ur, e => this._end(e)), this._element.classList.add(Zr)) : (x.on(this._element, Wr, e => this._start(e)), x.on(this._element, Br, e => this._move(e)), x.on(this._element, Yr, e => this._end(e)))
              }
          ...
          class tt extends he {
              constructor(e, t) {
                  super(e, t), this._interval = null, this._activeElement = null, this._isSliding = !1, this.touchTimeout = null, this._swipeHelper = null, this._indicatorsElement = C.findOne(_o, this._element), this._addEventListeners(), this._config.ride === Zn && this.cycle()
              }
              static get Default() {
                  return jo
              }
              ...
              _addEventListeners() {
                  this._config.keyboard && x.on(this._element, so, e => this._keydown(e)), this._config.pause === "hover" && (x.on(this._element, ao, () => this.pause()), x.on(this._element, lo, () => this._maybeEnableCycle())), this._config.touch && It.isSupported() && this._addTouchEventListeners()
              }
              _addTouchEventListeners() {
                  for (const i of C.find(xo, this._element)) x.on(i, co, o => o.preventDefault());
                  const t = {
                      leftCallback: () => this._slide(this._directionToOrder(et)),
                      rightCallback: () => this._slide(this._directionToOrder($t)),
                      endCallback: () => {
                          this._config.pause === "hover" && (this.pause(), this.touchTimeout && clearTimeout(this.touchTimeout), this.touchTimeout = setTimeout(() => this._maybeEnableCycle(), ro + this._config.interval))
                      }
                  };
              ...
              _slide(e, t = null) {
                  ...
                  if (y(oo).defaultPrevented || !i || !c) return;
                  ...
                  const P = () => {
                      c.classList.remove(j, I), c.classList.add(Pt), i.classList.remove(Pt, I, j), this._isSliding = !1, y(ln)
                  };
          ...
          class it extends he {
              ...
              show() {
                  ...
                  if (this._config.parent && (e = this._getFirstLevelChildren(Vo).filter(y => y !== this._element).map(y => it.getOrCreateInstance(y, {
                          toggle: !1
                      }))), e.length && e[0]._isTransitioning || x.trigger(this._element, So).defaultPrevented) return;
                  for (const y of e) y.hide();
                  const i = this._getDimension();
                  this._element.classList.remove(nt), this._element.classList.add(Rt), this._element.style[i] = 0, this._addAriaAndCollapsedClass(this._triggerArray, !0), this._isTransitioning = !0;
                  const o = () => {
                          this._isTransitioning = !1, this._element.classList.remove(Rt), this._element.classList.add(nt, cn), this._element.style[i] = "", x.trigger(this._element, Mo)
                      },
                      d = `scroll${i[0].toUpperCase()+i.slice(1)}`;
                  this._queueCallback(o, this._element, !0), this._element.style[i] = `${this._element[d]}px`
              }
              hide() {
                  if (this._isTransitioning || !this._isShown() || x.trigger(this._element, Co).defaultPrevented) return;
                  const t = this._getDimension();
                  this._element.style[t] = `${this._element.getBoundingClientRect()[t]}px`, w(this._element), this._element.classList.add(Rt), this._element.classList.remove(nt, cn);
                  ...
                  const i = () => {
                      this._isTransitioning = !1, this._element.classList.remove(Rt), this._element.classList.add(nt), x.trigger(this._element, No)
                  };
              ...
              _addAriaAndCollapsedClass(e, t) {
                  if (e.length)
                      for (const i of e) i.classList.toggle(Do, !t), i.setAttribute("aria-expanded", t)
              }
              static jQueryInterface(e) {
                  const t = {};
          ...
          x.on(document, Lo, dn, function(n) {
              ...
              for (const e of C.getMultipleElementsFromSelector(this)) it.getOrCreateInstance(e, {
                  toggle: !1
              }).toggle()
          }), $(it);
          var te = "top",
          ...
          function bt(n) {
              for (var e = se(n), t = fi(n); t && Ko(t) && Ae(t).position === "static";) t = fi(t);
          ...
          var Yo = function(e, t) {
              ...
              })) : e, mi(typeof e != "number" ? e : gi(e, rt))
          };
          ...
          function xi(n) {
              ...
              if (M) {
                  var K = bt(t),
                      G = "clientHeight",
                      q = "clientWidth";
                  if (K === se(t) && (K = Ce(t), Ae(K).position !== "static" && y === "absolute" && (G = "scrollHeight", q = "scrollWidth")), K = K, o === te || (o === ne || o === oe) && c === ot) {
                      V = re;
              ...
              if (N = ye.x, R = ye.y, b) {
                  var ie;
                  return Object.assign({}, ee, (ie = {}, ie[V] = X ? "0" : "", ie[Q] = Y ? "0" : "", ie.transform = (F.devicePixelRatio || 1) <= 1 ? "translate(" + N + "px, " + R + "px)" : "translate3d(" + N + "px, " + R + "px, 0)", ie))
              }
              return Object.assign({}, ee, (e = {}, e[V] = X ? R + "px" : "", e[Q] = Y ? N + "px" : "", e.transform = "", e))
          }
          ...
          function ls(n) {
              ...
              if (!e.modifiersData[i]._skip) {
                  for (var o = t.mainAxis, c = o === void 0 ? !0 : o, d = t.altAxis, y = d === void 0 ? !0 : d, b = t.fallbackPlacements, M = t.padding, j = t.boundary, I = t.rootBoundary, P = t.altBoundary, N = t.flipVariations, B = N === void 0 ? !0 : N, R = t.allowedAutoPlacements, z = e.options.placement, Y = xe(z), X = Y === z, Q = b || (X || !B ? [Ft(z)] : as(z)), V = [z].concat(Q).reduce(function(ht, Le) {
                      ...
                      var Zt = Ft(me),
                          Ye = [];
                      if (c && Ye.push(ae[ye] <= 0), y && Ye.push(ae[me] <= 0, ae[Zt] <= 0), Ye.every(function(ht) {
                              return ht
                          })) {
                          J = ee, q = !1;
                          break
                  ...
                  if (q)
                      for (var Jt = B ? 3 : 1, Vn = function(Le) {
                              var Mt = V.find(function(en) {
                                  var Ge = G.get(en);
                                  if (Ge) return Ge.slice(0, Le).every(function(Hn) {
                                      return Hn
                                  })
                              });
              ...
              if (K) {
                  if (c) {
                      var ie, We = V === "y" ? te : ne,
                          ...
                          en = Le[Be],
                          Ge = At(0, G[ae], ht[ae]),
                          Hn = Q ? G[ae] / 2 - Jt - Ge - Mt - Z.mainAxis : Vn - Ge - Mt - Z.mainAxis,
                          sc = Q ? -G[ae] / 2 + Jt + Ge + en + Z.mainAxis : St + Ge + en + Z.mainAxis,
                          kn = e.elements.arrow && bt(e.elements.arrow),
                          ac = kn ? V === "y" ? kn.clientTop || 0 : kn.clientLeft || 0 : 0,
                          mr = (ie = ee == null ? void 0 : ee[V]) != null ? ie : 0,
                          lc = me + Hn - mr - ac,
                          cc = me + sc - mr,
                          gr = At(N ? Ht(Zt, lc) : Zt, me, N ? Pe(Ye, cc) : Ye);
                      K[V] = gr, ye[V] = gr - me
                  }
                  if (y) {
                      var vr, dc = V === "x" ? te : ne,
                          ...
                          xr = Ue + z[dc],
                          _r = Ue - z[uc],
                          zn = [te, ne].indexOf(Y) !== -1,
                          Er = (vr = ee == null ? void 0 : ee[F]) != null ? vr : 0,
                          br = zn ? xr : Ue - G[tn] - q[tn] - Er + Z.altAxis,
                          Ar = zn ? Ue + G[tn] + q[tn] - Er - Z.altAxis : _r,
                          jr = N && zn ? Bo(br, Ue, Ar) : At(N ? br : xr, Ue, N ? Ar : _r);
                      K[F] = jr, ye[F] = jr - Ue
                  }
          ...
          function vs(n, e, t) {
              ...
              return (i || !i && !t) && ((ve(e) !== "body" || An(c)) && (y = ms(e)), ce(e) ? (b = lt(e, !0), b.x += e.clientLeft, b.y += e.clientTop) : c && (b.x = bn(c))), {
                  ...
                  var j = {
                      ...
                      N = {
                          ...
                          setOptions: function(Y) {
                              ...
                              R(), j.options = Object.assign({}, c, j.options, X), j.scrollParents = {
          ...
          class fe extends he {
              ...
              show() {
                  ...
                  if (!x.trigger(this._element, Ls, e).defaultPrevented) {
                      if (this._createPopper(), "ontouchstart" in document.documentElement && !this._parent.closest(Fs))
                          for (const i of [].concat(...document.body.children)) x.on(i, "mouseover", T);
                      this._element.focus(), this._element.setAttribute("aria-expanded", !0), this._menu.classList.add(ut), this._element.classList.add(ut), x.trigger(this._element, Ds, e)
                  }
              }
              hide() {
                  if (v(this._element) || !this._isShown()) return;
              ...
              _completeHide(e) {
                  if (!x.trigger(this._element, Cs, e).defaultPrevented) {
                      ...
                      this._popper && this._popper.destroy(), this._menu.classList.remove(ut), this._element.classList.remove(ut), this._element.setAttribute("aria-expanded", "false"), be.removeDataAttribute(this._menu, "popper"), x.trigger(this._element, Ns, e)
                  }
              }
              _getConfig(e) {
              ...
              _getPlacement() {
                  ...
                  if (e.classList.contains(Hs)) return Zs;
              ...
              static clearMenus(e) {
                  if (e.button === Ms || e.type === "keyup" && e.key !== Ii) return;
                  const t = C.find(ks);
                  for (const i of t) {
          ...
          x.on(document, Ri, Ve, fe.dataApiKeydownHandler), x.on(document, Ri, Wt, fe.dataApiKeydownHandler), x.on(document, Pi, fe.clearMenus), x.on(document, Is, fe.clearMenus), x.on(document, Pi, Ve, function(n) {
          ...
          class zi extends gt {
              ...
              _getElement() {
                  if (!this._element) {
                      ...
                      e.className = this._config.className, this._config.isAnimated && e.classList.add(ea), this._element = e
                  }
          ...
          class Ki extends gt {
              ...
              activate() {
                  this._isActive || (this._config.autofocus && this._config.trapElement.focus(), x.off(document, Bt), x.on(document, ra, e => this._handleFocusin(e)), x.on(document, oa, e => this._handleKeydown(e)), this._isActive = !0)
              }
              deactivate() {
          ...
          class He extends he {
              constructor(e, t) {
                  super(e, t), this._dialog = C.findOne(Aa, this._element), this._backdrop = this._initializeBackDrop(), this._focustrap = this._initializeFocusTrap(), this._isShown = !1, this._isTransitioning = !1, this._scrollBar = new Sn, this._addEventListeners()
              }
              static get Default() {
                  return Ta
              }
              ...
              hide() {
                  !this._isShown || this._isTransitioning || x.trigger(this._element, ha).defaultPrevented || (this._isShown = !1, this._isTransitioning = !0, this._focustrap.deactivate(), this._element.classList.remove(Qi), this._queueCallback(() => this._hideModal(), this._element, this._isAnimated()))
              }
              dispose() {
              ...
              _showElement(e) {
                  ...
                  const i = () => {
                      this._config.focus && this._focustrap.activate(), this._isTransitioning = !1, x.trigger(this._element, ya, {
                          relatedTarget: e
                      })
                  };
              ...
              _triggerBackdropTransition() {
                  if (x.trigger(this._element, fa).defaultPrevented) return;
                  const t = this._element.scrollHeight > document.documentElement.clientHeight,
                      i = this._element.style.overflowY;
                  i === "hidden" || this._element.classList.contains(Mn) || (t || (this._element.style.overflowY = "hidden"), this._element.classList.add(Mn), this._queueCallback(() => {
          ...
          class we extends he {
              ...
              show(e) {
                  ...
                  this._isShown = !0, this._backdrop.show(), this._config.scroll || new Sn().hide(), this._element.setAttribute("aria-modal", !0), this._element.setAttribute("role", "dialog"), this._element.classList.add(qi);
                  const i = () => {
                      (!this._config.scroll || this._config.backdrop) && this._focustrap.activate(), this._element.classList.add(Ji), this._element.classList.remove(qi), x.trigger(this._element, Da, {
                          relatedTarget: e
                      })
                  };
              ...
              hide() {
                  if (!this._isShown || x.trigger(this._element, Ia).defaultPrevented) return;
                  this._focustrap.deactivate(), this._element.blur(), this._isShown = !1, this._element.classList.add(er), this._backdrop.hide();
                  const t = () => {
                      this._element.classList.remove(Ji, er), this._element.removeAttribute("aria-modal"), this._element.removeAttribute("role"), this._config.scroll || new Sn().reset(), x.trigger(this._element, ir)
                  };
          ...
          function Wa(n, e, t) {
              ...
              for (const d of c) {
                  ...
                  const b = [].concat(...d.attributes),
                      M = [].concat(e["*"] || [], e[y] || []);
                  for (const j of b) Ka(j, M) || d.removeAttribute(j.nodeName)
              }
          ...
          class ke extends he {
              ...
              show() {
                  ...
                  if (this._element.ownerDocument.documentElement.contains(this.tip) || (c.append(o), x.trigger(this._element, this.constructor.eventName(sl))), this._popper = this._createPopper(o), o.classList.add(Gt), "ontouchstart" in document.documentElement)
                      for (const y of [].concat(...document.body.children)) x.on(y, "mouseover", T);
                  const d = () => {
                      x.trigger(this._element, this.constructor.eventName(ol)), this._isHovered === !1 && this._leave(), this._isHovered = !1
                  };
                  this._queueCallback(d, this.tip, this._isAnimated())
              }
              hide() {
                  if (!this._isShown() || x.trigger(this._element, this.constructor.eventName(nl)).defaultPrevented) return;
                  ...
                  this._activeTrigger[el] = !1, this._activeTrigger[Nn] = !1, this._activeTrigger[wt] = !1, this._isHovered = null;
                  const i = () => {
                      this._isWithActiveTrigger() || (this._isHovered || this._disposePopper(), this._element.removeAttribute("aria-describedby"), x.trigger(this._element, this.constructor.eventName(il)))
                  };
              ...
              _createTipElement(e) {
                  ...
                  if (!t) return null;
                  t.classList.remove(Cn, Gt), t.classList.add(`bs-${this.constructor.NAME}-auto`);
                  const i = h(this.constructor.NAME).toString();
                  return t.setAttribute("id", i), this._isAnimated() && t.classList.add(Cn), t
              }
              setContent(e) {
              ...
              _setListeners() {
                  ...
                  for (const t of e)
                      if (t === "click") x.on(this._element, this.constructor.eventName(al), this._config.selector, i => {
                      ...
                      x.on(this._element, i, this._config.selector, c => {
                          ...
                          d._activeTrigger[c.type === "focusin" ? Nn : wt] = !0, d._enter()
                      }), x.on(this._element, o, this._config.selector, c => {
                          const d = this._initializeOnDelegatedTarget(c);
                          d._activeTrigger[c.type === "focusout" ? Nn : wt] = d._element.contains(c.relatedTarget), d._leave()
                      })
                  }
              ...
              _getConfig(e) {
                  ...
                  for (const i of Object.keys(t)) Za.has(i) && delete t[i];
                  return e = {
                      ...t,
                      ...typeof e == "object" && e ? e : {}
          ...
          class Tt extends he {
              ...
              _maybeEnableSmoothScroll() {
                  this._config.smoothScroll && (x.off(this._config.target, ar), x.on(this._config.target, ar, Dn, e => {
              ...
              _process(e) {
                  this._activeTarget !== e && (this._clearActiveClass(this._config.target), this._activeTarget = e, e.classList.add(pt), this._activateParents(e), x.trigger(this._element, bl, {
                      relatedTarget: e
                  }))
              }
              _activateParents(e) {
                  ...
                  for (const t of C.parents(e, Tl))
                      for (const i of C.prev(t, Ol)) i.classList.add(pt)
              }
              _clearActiveClass(e) {
          ...
          x.on(window, Al, () => {
              for (const n of C.find(wl)) Tt.getOrCreateInstance(n)
          }), $(Tt);
          const Ll = "tab",
              ze = ".bs.tab",
              Dl = `hide${ze}`,
          ...
          class Ke extends he {
              constructor(e) {
                  super(e), this._parent = this._element.closest(Wl), this._parent && (this._setInitialAttributes(this._parent, this._getChildren()), x.on(this._element, Vl, t => this._keydown(t)))
              }
              static get NAME() {
                  return Ll
              }
              ...
              _activate(e, t) {
                  ...
                  const i = () => {
                      ...
                      e.removeAttribute("tabindex"), e.setAttribute("aria-selected", !0), this._toggleDropDown(e, !0), x.trigger(e, Pl, {
                          relatedTarget: t
                      })
                  };
              ...
              _deactivate(e, t) {
                  ...
                  const i = () => {
                      ...
                      e.setAttribute("aria-selected", !1), e.setAttribute("tabindex", "-1"), this._toggleDropDown(e, !1), x.trigger(e, Il, {
                          relatedTarget: t
                      })
                  };
                  this._queueCallback(i, e, e.classList.contains(pr))
              ...
              _keydown(e) {
                  if (![kl, cr, zl, dr, In, ur].includes(e.key)) return;
                  e.stopPropagation(), e.preventDefault();
                  const t = this._getChildren().filter(o => !v(o));
                  let i;
                  if ([In, ur].includes(e.key)) i = t[e.key === In ? 0 : t.length - 1];
                  else {
              ...
              _toggleDropDown(e, t) {
                  ...
                  if (!i.classList.contains(Fl)) return;
                  const o = (c, d) => {
                      const y = C.findOne(c, i);
                      y && y.classList.toggle(d, t)
                  };
                  o(hr, Fe), o(Kl, $n), i.setAttribute("aria-expanded", t)
              }
          ...
          x.on(document, Rl, fr, function(n) {
              ...
              for (const n of C.find(Gl)) Ke.getOrCreateInstance(n)
          }), $(Ke);
          const Ul = "toast",
              Ne = ".bs.toast",
              Xl = `mouseover${Ne}`,
          ...
          class Ot extends he {
              ...
              show() {
                  ...
                  const t = () => {
                      this._element.classList.remove(Qt), x.trigger(this._element, nc), this._maybeScheduleHide()
                  };
              ...
              hide() {
                  ...
                  const t = () => {
                      this._element.classList.add(yr), this._element.classList.remove(Qt, Xt), x.trigger(this._element, ec)
                  };
  ...
  const Sr = Fn(Or),
      ...
      nn = (U, k = !1) => {
          ...
          return U.style.setProperty("--submenu-height", f + "px"), f
      };
  class Mr {
      constructor(k, s = {}) {
          this.sidebarEL = k instanceof HTMLElement ? k : document.querySelector(k), this.options = s, this.init()
      }
      init() {
          ...
          }, 300), this.options.recalculateHeight && Cr(Xe)
      }
      onResize() {
  ...
  const Bn = U => {
          if (!Xe) return;
          Ct(window) && (U.classList.add("active"), U.classList.add("sidebar-desktop"));
  ...
  document.readyState !== "loading" ? Bn(Xe) : window.addEventListener("DOMContentLoaded", () => Bn(Xe)), window.Sidebar = Mr, Xe && new window.Sidebar(Xe), window.bootstrap = Sr, Tr.replace()
});